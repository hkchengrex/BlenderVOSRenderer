...
class VOSTrajRunner(Module):
    ...
    **Configuration**:
    ...
    def __init__(self, config):
        ...
        light_runner_config = config.get_raw_dict("light_runner", {})
        ...
        self._light_runner = Utility.initialize_modules([light_runner_config], {})[0]
    ...
    def run(self):
        ...
        self._light_runner.run(n_frames)
